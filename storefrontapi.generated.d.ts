...
export type MenuItemFragment = Pick<StorefrontAPI.MenuItem, 'id' | 'title' | 'url'>

export type ChildMenuItemFragment = Pick<StorefrontAPI.MenuItem, 'id' | 'title' | 'url'>

export type ParentMenuItemFragment = Pick<StorefrontAPI.MenuItem, 'id' | 'title' | 'url'> & {
